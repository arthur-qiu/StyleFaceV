...
#     **kwargs: Any,
# ) -> ResNet_Feature:
#     model = ResNet_Feature(block, layers, **kwargs)
#     if pretrained:
#         state_dict = load_state_dict_from_url(model_urls[arch], progress=progress)
#         model.load_state_dict(state_dict)
#     return model
...
# def wide_resnet50_2_feature(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
#     r"""Wide ResNet-50-2 model from
#     `"Wide Residual Networks" <https://arxiv.org/pdf/1605.07146.pdf>`_.
#     The model is the same as ResNet except for the bottleneck number of channels
#     which is twice larger in every block. The number of channels in outer 1x1
...
#     """
#     kwargs["width_per_group"] = 64 * 2
#     return _resnet_feature("wide_resnet50_2_feature", Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs)
